...
<div id="mainSlider" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
            ...
            <div class="carousel-caption">
                <div class="col-xl-6 col-lg-8 col-md-12 col-12 animate__animated animate__fadeInRight">
                    <div class="card text-black p-5">
                        <h1>FOOD WASTE</h1>
                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Porro et obcaecati dolores sed
                            laboriosam aspernatur ex autem eaque amet,</p>
        ...
        <div class="carousel-item">
            <img src="assets/img/top-view-trash-cooking-concept_23-2149056474.avif" class="d-block w-100 animate__animated animate__zoomIn" alt="...">
            <div class="carousel-caption">
                <div class="col-xl-6 col-lg-8 animate__animated animate__fadeInRight">
                    <div class="card text-black p-5">
                        <h1>FOOD WASTE</h1>
